...
public class Note {
	...
	private List<String> noteReminders;
	...
	public Note(int noteId, String noteTitle, String noteContent, String noteStatus, List<String> noteReminders,
			Date noteCreationDate, Category category, List<Reminder> reminders, String noteCreatedBy) {
		super();
		this.noteId = noteId;
	...
	public List<String> getNoteReminders() {
		return noteReminders;
	}
	public void setNoteReminders(List<String> noteReminders) {
		this.noteReminders = noteReminders;
	}
	...
	public String toString() {
		return "Note [noteId=" + noteId + ", noteTitle=" + noteTitle + ", noteContent=" + noteContent + ", noteStatus="
				+ noteStatus + ", noteReminders=" + noteReminders + ", noteCreationDate=" + noteCreationDate
				+ ", category=" + category + ", reminders=" + reminders + ", noteCreatedBy=" + noteCreatedBy + "]";
	}
